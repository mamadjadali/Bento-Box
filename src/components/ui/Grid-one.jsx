    ...
    <div class="sm:h-80 md:col-span-2 md:row-span-1 col-span-full  flex-col border border-gray-600/50 bg-neutral-50/5 backdrop-blur rounded-[30px] flex rounded-tl-xl rounded-br-[4px]">
		<div class="pt-1 m-7 justify-start flex items-center">
			...
			<p class="font-sans text-sm">
				Hi, I'm Mohsen <br />
				<span class="hidden md:block text-[12px]">Videographer | Photographer</span>
			</p>
			<div class="flex items-center ml-auto">
				<div class="w-9 h-9 rounded-md bg-neutral-50/5 hover:bg-neutral-50/5 hover:border-gray-500/90 duration-200 backdrop-blur  mr-2 flex justify-center items-center">
		...
		<div class="m-3 ml-5 justify-center items-center">
			<div class="font-sans text-2xl ml-3 mb-5">Video Production, Inspired by Life</div>
			<p class="font-normal text-sm text-justify text-[#919398] sm:ml-3 sm:mr-6 mb-5">
				I'm a creative video producer with 8 years of industry experience.
				My expertise lies in storytelling and collaborating with teams to craft compelling content.
				I'm passionate about delivering high-quality videos that deeply connect with audiences, from the earliest concept stages through to post-production.
				Let's connect and discuss how we can enhance your next project together.
			</p>
		</div>
	</div>
  )
